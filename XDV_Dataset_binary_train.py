from data.dataset import XDV_Dataset
from train.trainer import BinaryTrainer
from evaluation.evaluator import Evaluator
from model import AnomalyDetector

# ─── 1. Dataset ─────────────────────────────────────────────────────────
train_ds = XDV_Dataset(
    split="train",
...
eval_results = evaluator.evaluate(
    ...
    tolerance_sec=3,        # Segment birleştirme zaman toleransı (saniye)
    padding_sec=2,          # Tespit edilen segmentlere eklenen güvenlik payı (saniye)
